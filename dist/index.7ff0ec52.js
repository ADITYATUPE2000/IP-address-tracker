...
})({"bXNTa":[function(require,module,exports,__globalThis) {
...
},{}],"dUn2x":[function(require,module,exports,__globalThis) {
...
const executeCode = ()=>{
    ...
    else if (validDomainTest.test(value)) fetchData("", value);
    else {
...
const fetchData = async (value, domain)=>{
    try {
        ...
        popup = `${data.location.city}, ${data.location.country} \u{1F4CC}`;
...
},{}]},["bXNTa","dUn2x"], "dUn2x", "parcelRequire94c2")
